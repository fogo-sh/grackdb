...
func (m *DiscordAccountMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().DiscordAccount.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *DiscordBotMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().DiscordBot.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *GithubAccountMutation) IDs(ctx context.Context) ([]int, error) {
	...
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().GithubAccount.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *GithubOrganizationMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().GithubOrganization.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *GithubOrganizationMemberMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().GithubOrganizationMember.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProjectAssociationMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ProjectAssociation.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProjectContributorMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProjectTechnologyMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *RepositoryMutation) AddedEdges() []string {
	...
	if m.technologies != nil {
		edges = append(edges, repository.EdgeTechnologies)
	}
	return edges
}
...
func (m *RepositoryMutation) AddedIDs(name string) []ent.Value {
	...
	case repository.EdgeSites:
		...
		return ids
	case repository.EdgeTechnologies:
		ids := make([]ent.Value, 0, len(m.technologies))
		for id := range m.technologies {
			ids = append(ids, id)
		}
...
type RepositoryTechnologyMutation struct {
	...
	typ               string
	id                *int
	_type             *repositorytechnology.Type
	clearedFields     map[string]struct{}
	repository        *int
	clearedrepository bool
	technology        *int
	...
	oldValue          func(context.Context) (*RepositoryTechnology, error)
	predicates        []predicate.RepositoryTechnology
}

var _ ent.Mutation = (*RepositoryTechnologyMutation)(nil)

// repositorytechnologyOption allows management of the mutation configuration using functional options.
type repositorytechnologyOption func(*RepositoryTechnologyMutation)

// newRepositoryTechnologyMutation creates new mutation for the RepositoryTechnology entity.
func newRepositoryTechnologyMutation(c config, op Op, opts ...repositorytechnologyOption) *RepositoryTechnologyMutation {
	m := &RepositoryTechnologyMutation{
		config:        c,
		op:            op,
		typ:           TypeRepositoryTechnology,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withRepositoryTechnologyID sets the ID field of the mutation.
func withRepositoryTechnologyID(id int) repositorytechnologyOption {
	return func(m *RepositoryTechnologyMutation) {
		var (
			err   error
			once  sync.Once
			value *RepositoryTechnology
		)
		m.oldValue = func(ctx context.Context) (*RepositoryTechnology, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().RepositoryTechnology.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withRepositoryTechnology sets the old RepositoryTechnology of the mutation.
func withRepositoryTechnology(node *RepositoryTechnology) repositorytechnologyOption {
	return func(m *RepositoryTechnologyMutation) {
		m.oldValue = func(context.Context) (*RepositoryTechnology, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m RepositoryTechnologyMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m RepositoryTechnologyMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *RepositoryTechnologyMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().RepositoryTechnology.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetType sets the "type" field.
func (m *RepositoryTechnologyMutation) SetType(r repositorytechnology.Type) {
	m._type = &r
}

// GetType returns the value of the "type" field in the mutation.
func (m *RepositoryTechnologyMutation) GetType() (r repositorytechnology.Type, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// OldType returns the old "type" field's value of the RepositoryTechnology entity.
// If the RepositoryTechnology object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RepositoryTechnologyMutation) OldType(ctx context.Context) (v repositorytechnology.Type, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldType is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *RepositoryTechnologyMutation) Type() string {
	return m.typ
}
...
func (m *RepositoryTechnologyMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._type != nil {
		fields = append(fields, repositorytechnology.FieldType)
	}
	return fields
}
...
func (m *RepositoryTechnologyMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	return nil, fmt.Errorf("unknown RepositoryTechnology field %s", name)
}
...
func (m *RepositoryTechnologyMutation) SetField(name string, value ent.Value) error {
	switch name {
	case repositorytechnology.FieldType:
		v, ok := value.(repositorytechnology.Type)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetType(v)
	...
	return fmt.Errorf("unknown RepositoryTechnology field %s", name)
}
...
func (m *RepositoryTechnologyMutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown RepositoryTechnology numeric field %s", name)
}
...
func (m *RepositoryTechnologyMutation) ClearField(name string) error {
	return fmt.Errorf("unknown RepositoryTechnology nullable field %s", name)
}
...
func (m *RepositoryTechnologyMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.repository != nil {
		edges = append(edges, repositorytechnology.EdgeRepository)
	}
	if m.technology != nil {
		edges = append(edges, repositorytechnology.EdgeTechnology)
	}
	return edges
}
...
func (m *RepositoryTechnologyMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case repositorytechnology.EdgeRepository:
		if id := m.repository; id != nil {
			return []ent.Value{*id}
		}
	case repositorytechnology.EdgeTechnology:
		if id := m.technology; id != nil {
			return []ent.Value{*id}
		}
	}
...
func (m *RepositoryTechnologyMutation) ClearEdge(name string) error {
	...
	return fmt.Errorf("unknown RepositoryTechnology unique edge %s", name)
}
...
func (m *RepositoryTechnologyMutation) ResetEdge(name string) error {
	...
	return fmt.Errorf("unknown RepositoryTechnology edge %s", name)
}
...
type TechnologyMutation struct {
	...
	clearedFields              map[string]struct{}
	parent_technologies        map[int]struct{}
	removedparent_technologies map[int]struct{}
	clearedparent_technologies bool
...
func (m *TechnologyMutation) AddParentTechnologyIDs(ids ...int) {
	if m.parent_technologies == nil {
		m.parent_technologies = make(map[int]struct{})
	}
	for i := range ids {
		m.parent_technologies[ids[i]] = struct{}{}
	}
}
...
func (m *TechnologyMutation) ClearParentTechnologies() {
	m.clearedparent_technologies = true
}
...
func (m *TechnologyMutation) RemoveParentTechnologyIDs(ids ...int) {
	if m.removedparent_technologies == nil {
		m.removedparent_technologies = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.parent_technologies, ids[i])
		m.removedparent_technologies[ids[i]] = struct{}{}
	}
}
...
func (m *TechnologyMutation) RemovedParentTechnologiesIDs() (ids []int) {
	for id := range m.removedparent_technologies {
		ids = append(ids, id)
	}
	return
}
...
func (m *TechnologyMutation) ParentTechnologiesIDs() (ids []int) {
	for id := range m.parent_technologies {
		ids = append(ids, id)
	}
	return
}
...
func (m *TechnologyMutation) ResetParentTechnologies() {
	m.parent_technologies = nil
	m.clearedparent_technologies = false
	m.removedparent_technologies = nil
}
...
func (m *TechnologyMutation) AddChildTechnologyIDs(ids ...int) {
	if m.child_technologies == nil {
		m.child_technologies = make(map[int]struct{})
	}
	for i := range ids {
		m.child_technologies[ids[i]] = struct{}{}
	}
}
...
func (m *TechnologyMutation) ClearChildTechnologies() {
	m.clearedchild_technologies = true
}
...
func (m *TechnologyMutation) RemoveChildTechnologyIDs(ids ...int) {
	if m.removedchild_technologies == nil {
		m.removedchild_technologies = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.child_technologies, ids[i])
		m.removedchild_technologies[ids[i]] = struct{}{}
	}
}
...
func (m *TechnologyMutation) RemovedChildTechnologiesIDs() (ids []int) {
	for id := range m.removedchild_technologies {
		ids = append(ids, id)
	}
	return
}
...
func (m *TechnologyMutation) ChildTechnologiesIDs() (ids []int) {
	for id := range m.child_technologies {
		ids = append(ids, id)
	}
	return
}
...
func (m *TechnologyMutation) ResetChildTechnologies() {
	m.child_technologies = nil
	m.clearedchild_technologies = false
...
func (m *TechnologyMutation) AddedEdges() []string {
	...
	if m.repositories != nil {
		edges = append(edges, technology.EdgeRepositories)
	}
	return edges
}
...
func (m *TechnologyMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case technology.EdgeParentTechnologies:
		ids := make([]ent.Value, 0, len(m.parent_technologies))
		for id := range m.parent_technologies {
			ids = append(ids, id)
		}
		return ids
	case technology.EdgeChildTechnologies:
		ids := make([]ent.Value, 0, len(m.child_technologies))
		for id := range m.child_technologies {
			ids = append(ids, id)
		}
		return ids
	case technology.EdgeProjects:
		...
		return ids
	case technology.EdgeRepositories:
		ids := make([]ent.Value, 0, len(m.repositories))
		for id := range m.repositories {
			ids = append(ids, id)
		}
...
func (m *TechnologyMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case technology.EdgeParentTechnologies:
		ids := make([]ent.Value, 0, len(m.removedparent_technologies))
		for id := range m.removedparent_technologies {
			ids = append(ids, id)
		}
		return ids
	case technology.EdgeChildTechnologies:
		ids := make([]ent.Value, 0, len(m.removedchild_technologies))
		for id := range m.removedchild_technologies {
			ids = append(ids, id)
		}
		return ids
...
type TechnologyAssociationMutation struct {
	...
	typ           string
	id            *int
	_type         *technologyassociation.Type
	clearedFields map[string]struct{}
	parent        *int
	clearedparent bool
	child         *int
	...
	oldValue      func(context.Context) (*TechnologyAssociation, error)
	predicates    []predicate.TechnologyAssociation
}

var _ ent.Mutation = (*TechnologyAssociationMutation)(nil)

// technologyassociationOption allows management of the mutation configuration using functional options.
type technologyassociationOption func(*TechnologyAssociationMutation)

// newTechnologyAssociationMutation creates new mutation for the TechnologyAssociation entity.
func newTechnologyAssociationMutation(c config, op Op, opts ...technologyassociationOption) *TechnologyAssociationMutation {
	m := &TechnologyAssociationMutation{
		config:        c,
		op:            op,
		typ:           TypeTechnologyAssociation,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withTechnologyAssociationID sets the ID field of the mutation.
func withTechnologyAssociationID(id int) technologyassociationOption {
	return func(m *TechnologyAssociationMutation) {
		var (
			err   error
			once  sync.Once
			value *TechnologyAssociation
		)
		m.oldValue = func(ctx context.Context) (*TechnologyAssociation, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().TechnologyAssociation.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withTechnologyAssociation sets the old TechnologyAssociation of the mutation.
func withTechnologyAssociation(node *TechnologyAssociation) technologyassociationOption {
	return func(m *TechnologyAssociationMutation) {
		m.oldValue = func(context.Context) (*TechnologyAssociation, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m TechnologyAssociationMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m TechnologyAssociationMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *TechnologyAssociationMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().TechnologyAssociation.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetType sets the "type" field.
func (m *TechnologyAssociationMutation) SetType(t technologyassociation.Type) {
	m._type = &t
}

// GetType returns the value of the "type" field in the mutation.
func (m *TechnologyAssociationMutation) GetType() (r technologyassociation.Type, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// OldType returns the old "type" field's value of the TechnologyAssociation entity.
// If the TechnologyAssociation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TechnologyAssociationMutation) OldType(ctx context.Context) (v technologyassociation.Type, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldType is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// Op returns the operation name.
func (m *TechnologyAssociationMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (TechnologyAssociation).
func (m *TechnologyAssociationMutation) Type() string {
	return m.typ
}
...
func (m *TechnologyAssociationMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._type != nil {
		fields = append(fields, technologyassociation.FieldType)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *TechnologyAssociationMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TechnologyAssociationMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case technologyassociation.FieldType:
		return m.OldType(ctx)
	}
	return nil, fmt.Errorf("unknown TechnologyAssociation field %s", name)
}
...
func (m *TechnologyAssociationMutation) SetField(name string, value ent.Value) error {
	switch name {
	case technologyassociation.FieldType:
		v, ok := value.(technologyassociation.Type)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetType(v)
	...
	return fmt.Errorf("unknown TechnologyAssociation field %s", name)
}
...
func (m *TechnologyAssociationMutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown TechnologyAssociation numeric field %s", name)
}
...
func (m *TechnologyAssociationMutation) ClearField(name string) error {
	return fmt.Errorf("unknown TechnologyAssociation nullable field %s", name)
}
...
func (m *TechnologyAssociationMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.parent != nil {
		edges = append(edges, technologyassociation.EdgeParent)
	}
	if m.child != nil {
		edges = append(edges, technologyassociation.EdgeChild)
	}
	return edges
}
...
func (m *TechnologyAssociationMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case technologyassociation.EdgeParent:
		if id := m.parent; id != nil {
			return []ent.Value{*id}
		}
	case technologyassociation.EdgeChild:
		if id := m.child; id != nil {
			return []ent.Value{*id}
		}
	}
...
func (m *TechnologyAssociationMutation) ClearEdge(name string) error {
	...
	return fmt.Errorf("unknown TechnologyAssociation unique edge %s", name)
}
...
func (m *TechnologyAssociationMutation) ResetEdge(name string) error {
	...
	return fmt.Errorf("unknown TechnologyAssociation edge %s", name)
}
