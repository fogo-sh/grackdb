...
func HasGithubAccount() predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GithubAccountTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, GithubAccountTable, GithubAccountColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasGithubAccountWith(preds ...predicate.GithubAccount) predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GithubAccountInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, GithubAccountTable, GithubAccountColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasGithubOrganization() predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GithubOrganizationTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, GithubOrganizationTable, GithubOrganizationColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasGithubOrganizationWith(preds ...predicate.GithubOrganization) predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GithubOrganizationInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, GithubOrganizationTable, GithubOrganizationColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
