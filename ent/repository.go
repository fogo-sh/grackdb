...
type RepositoryEdges struct {
	...
	namedTechnologies map[string][]*RepositoryTechnology
}
...
func (r *Repository) NamedDiscordBots(name string) ([]*DiscordBot, error) {
	if r.Edges.namedDiscordBots == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := r.Edges.namedDiscordBots[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (r *Repository) appendNamedDiscordBots(name string, edges ...*DiscordBot) {
	if r.Edges.namedDiscordBots == nil {
		r.Edges.namedDiscordBots = make(map[string][]*DiscordBot)
	}
	if len(edges) == 0 {
		r.Edges.namedDiscordBots[name] = []*DiscordBot{}
	} else {
		r.Edges.namedDiscordBots[name] = append(r.Edges.namedDiscordBots[name], edges...)
	}
}
...
func (r *Repository) NamedSites(name string) ([]*Site, error) {
	if r.Edges.namedSites == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := r.Edges.namedSites[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (r *Repository) appendNamedSites(name string, edges ...*Site) {
	if r.Edges.namedSites == nil {
		r.Edges.namedSites = make(map[string][]*Site)
	}
	if len(edges) == 0 {
		r.Edges.namedSites[name] = []*Site{}
	} else {
		r.Edges.namedSites[name] = append(r.Edges.namedSites[name], edges...)
	}
}
...
func (r *Repository) NamedTechnologies(name string) ([]*RepositoryTechnology, error) {
	if r.Edges.namedTechnologies == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := r.Edges.namedTechnologies[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (r *Repository) appendNamedTechnologies(name string, edges ...*RepositoryTechnology) {
	if r.Edges.namedTechnologies == nil {
		r.Edges.namedTechnologies = make(map[string][]*RepositoryTechnology)
	}
	if len(edges) == 0 {
		r.Edges.namedTechnologies[name] = []*RepositoryTechnology{}
	} else {
		r.Edges.namedTechnologies[name] = append(r.Edges.namedTechnologies[name], edges...)
	}
}
