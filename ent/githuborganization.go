...
type GithubOrganizationEdges struct {
	...
	namedMembers      map[string][]*GithubOrganizationMember
...
func (_go *GithubOrganization) NamedMembers(name string) ([]*GithubOrganizationMember, error) {
	if _go.Edges.namedMembers == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _go.Edges.namedMembers[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_go *GithubOrganization) appendNamedMembers(name string, edges ...*GithubOrganizationMember) {
	if _go.Edges.namedMembers == nil {
		_go.Edges.namedMembers = make(map[string][]*GithubOrganizationMember)
	}
	if len(edges) == 0 {
		_go.Edges.namedMembers[name] = []*GithubOrganizationMember{}
	} else {
		_go.Edges.namedMembers[name] = append(_go.Edges.namedMembers[name], edges...)
	}
}
...
func (_go *GithubOrganization) NamedRepositories(name string) ([]*Repository, error) {
	if _go.Edges.namedRepositories == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _go.Edges.namedRepositories[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_go *GithubOrganization) appendNamedRepositories(name string, edges ...*Repository) {
	if _go.Edges.namedRepositories == nil {
		_go.Edges.namedRepositories = make(map[string][]*Repository)
	}
	if len(edges) == 0 {
		_go.Edges.namedRepositories[name] = []*Repository{}
	} else {
		_go.Edges.namedRepositories[name] = append(_go.Edges.namedRepositories[name], edges...)
	}
}
